...
<div class="container-fluid">
  <ol class="breadcrumb">
    <li class="breadcrumb-item">
      <a href="admin.php?p=production">Hãng sản xuất</a>
    </li>
      ...
      <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
        <thead>
          <tr>
            ...
            <th>Mô tả</th>
            <th>
              <a href="admin.php?p=insertproduction">
  ...
  if(isset($_GET['id'])){
    ...
    // }
    foreach( $xpath->query("/production/hang[id='$id']") as $node) {
        $node->parentNode->removeChild($node);
    }
...
?>
  <tr>
    ...
    <td>
      ...
      <a href="admin.php?p=updateproduction&edit=<?php echo $Id?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
      <a href="admin.php?p=production&id=<?php echo $Id?>" onclick="return confirm('Bạn có muốn xóa hãng sx <?php echo $Id?>?')"><i class="fa fa-trash" aria-hidden="true"></i></a>
